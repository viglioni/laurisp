...
(setq asdasd "'{\"createLeadResponse\":{\"status\":\"duplicated\",\"offerType\":\"NO_OFFER\",\"cdpId\":null,\"duplicatedLeads\":[{\"addTime\":\"29/05/2020 11:00:21\",\"contactName\":\"Vinicius\",\"contactType\":\"owner\",\"crmId\":null,\"organizationName\":null}]},\"contactType\":\"affiliated-agent\"}'")
...
(defun json-utils-print-from-selection ()
  ...
  (let* ((selected-text (buffer-substring-no-properties (region-beginning) (region-end)))
         (parsed-json (shell-command-to-string (concat "jq <<< '" selected-text "'")))        
         (buff (get-buffer-create json-utils--buffer-name))
         (win (display-buffer-in-side-window buff '((side . right)
